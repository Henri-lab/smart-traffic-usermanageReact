export const measure = ({ map, draw }) => {
   ...
   * @type {string}
   */
  var continuePolygonMsg = "双击鼠标左键完成绘制";
  /**
   * 当用户正在绘制线时的提示信息文本
   * @type {string}
   */
  var continueLineMsg = "双击鼠标左键完成绘制";
  ...
  var pointerMoveHandler = function (evt) {
    ...
    /** @type {string} */
    var helpMsg = "单击鼠标左键开始绘制"; //当前默认提示信息
    //判断绘制几何类型设置相应的帮助提示信息
    if (sketch) {
